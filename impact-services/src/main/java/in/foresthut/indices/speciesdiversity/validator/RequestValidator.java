package in.foresthut.indices.speciesdiversity.validator;
...
public class RequestValidator {
    ...
    public static Optional<Status> validateSpeciesDiversityRequest(SpeciesDiversityRequest request) {
        if (request == null)
            return Optional.of(Status.INVALID_ARGUMENT.withDescription("Species diversity request cannot be null."));
